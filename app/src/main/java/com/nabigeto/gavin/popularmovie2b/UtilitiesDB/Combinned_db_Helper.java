 ...
 */
public class Combinned_db_Helper extends SQLiteOpenHelper {

    public static final int DATABASE_VERSION = 1;
    public static final String DATABASE_NAME ="combinned_database_a.db";


    public Combinned_db_Helper(Context context) {
